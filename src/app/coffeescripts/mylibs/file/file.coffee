define([
  ...
  pub = 
    ...
    init: (kb) ->
      ...
      # check to see if we are running in app mode
    ...
    save: (name, dataURI) ->
      ...
      if isApp
        ...
        $.publish "/postman/deliver", [{ message: { name: name, image: blob } }, "/file/save"]
    ...
    delete: (name) ->
      ...
      if isApp
        ...
        $.publish "/postman/deliver", [{ message: { name: name } }, "/file/destroy"]
